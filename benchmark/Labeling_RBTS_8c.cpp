...
inline void CCL_RBTS8_FindRuns(const unsigned int* pdata, int height, int width, Run* runs, UFPC& labelsolver) {
	Run* runs_up = runs;
...
void Labeling_RBTS8(unsigned* dest, const unsigned int* source, int height, int width) {
	...
	CCL_RBTS8_FindRuns(source, height, width, Data_run.runs, labelsolver);
