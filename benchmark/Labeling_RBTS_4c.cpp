...
void Labeling_RBTS4(unsigned* dest, const uint8_t* source, int height, int width, int data_width, int fmbits) {
	class RBTS4 {
		struct Run {
	...
	public:
		RBTS4(unsigned* _dest, const uint8_t* _source, int _height, int _width, int _data_width, int _fmbits)
	...
	RBTS4(dest, source, height, width, data_width, fmbits).Perform();
}