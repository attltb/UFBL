...
void PrintCompressedBits_X86(unsigned long bits, bool space = true);
void PrintCompressedBits_X64(unsigned long long bits, bool space = true);
void PrintCompressedBits_on_MsbFirst_X86(unsigned long bits, bool space = true);
void PrintCompressedBits_on_MsbFirst_X64(unsigned long long bits, bool space = true);
